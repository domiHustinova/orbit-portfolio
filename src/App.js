          ...
          <Card>
              ...
              <CardSectionContent>
                <Stack direction="column">
                  <List size="normal" type="secondary" spaceAfter={null}>
                    ...
                    <ListItem icon={<PriorityBoarding />}>
                      Close cooperation with developers, product managers and
                      other departments
                    </ListItem>
                    <ListItem icon={<PriorityBoarding />}>
                      Providing and managing internal technical support for our
                      Customer Support department - including solving or
                      outsourcing various technical issues related to the
                      functionality of our product, creating schedule, taking
                      care of documentation and communication with other
                      departments to improve the processes
                    </ListItem>
                  </List>
            ...
            <CardSection expandable>
              ...
              <CardSectionContent>
                <Stack direction="column">
                  <Text type="secondary">
                    I worked at this position as a part timer while still
                    studying. I was responsible for complex processing of all
                    tasks connected to incoming orders from customers. I handled
                    both inbound and outbound communication with customers,
                    airlines or partners and all their order related inquiries.
                    I worked independently but also cooperated with the
                    colleagues.
                  </Text>
                  <Stack direction="row" spacing="condensed" wrap>
